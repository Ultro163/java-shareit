...
public interface BookingService {
    ...
    List<Booking> getAllUserBooking(long userId, State state, Integer from, Integer size);

    List<Booking> getAllOwnerBooking(long ownerId, State state, Integer from, Integer size);
